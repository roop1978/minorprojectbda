...
def test_model():
    ...
    try:
        ...
        # Calculate fairness metrics on the test sample
        ...
        eq_odds, tpr_0, tpr_1, fpr_0, fpr_1 = fairness_metrics.equalized_odds(actual_clicks, predictions_tensor, sensitive_attr)
